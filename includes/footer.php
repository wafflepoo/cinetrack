<!-- Footer -->
<footer class="bg-gray-900/80 border-t border-gray-800 py-12 px-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
            <div class="fade-in">
                ...
                <p class="text-gray-400">
                    La plateforme ultime pour les cinéphiles passionnés.
                </p>
                <div class="flex space-x-4 mt-4">
                    <a href="#" class="text-gray-400 hover:text-orange-500 transition-all duration-300 transform hover:scale-110">
