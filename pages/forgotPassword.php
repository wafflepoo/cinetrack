...
<body class="gradient-bg text-white">
    ...
    <main class="auth-hero pt-20">
        <div class="min-h-screen flex items-center justify-center px-4 py-8">
            <div class="auth-container p-8 w-full max-w-md fade-in">
                <!-- Header -->
                ...
                <div class="text-center mt-6">
                    <a href="login.php" class="text-red-500 hover:text-red-400 font-semibold transition flex items-center justify-center space-x-2">
